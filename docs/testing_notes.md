...
| 컨테이너 GPU 프로브의 종료코드 검사를 없앤다 | `test_environment_check_fails_when_container_cannot_see_the_gpu` |
| JAX 백엔드 확인을 없앤다 | `test_environment_check_fails_when_jax_does_not_reach_the_gpu` |
...
mutation 56건도 전부 통과해야 한다. `.github/workflows/tests.yml`은 Python 3.9, 3.12,
